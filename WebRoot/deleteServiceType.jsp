  ...
  <body>
   <table  class="table table-striped">
     ...
     <a:forEach items="${requestScope.mlist}" var="serviceType">
      <form action="deleteServiceType.jhtml" method="post">
     	<tr align="center"><td>${serviceType.getTid()}</td><td>${serviceType.getTypeName()}</td><td><input type="text" name="ServiceTypeID" value="${serviceType.getTid()}" hidden="true"> <input type="submit" class="btn" value="删除"></td></tr>
      </form>
     </a:forEach>
    </table>
