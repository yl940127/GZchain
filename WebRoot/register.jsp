	...
	<div class="zxcf_nav_wper">
		<div class="zxcf_nav clearfix px1000">
			...
			<div class="zxcf_nav_r fr">
				<img src="images/lg_pic01.png" alt=""> <span onclick="toIndex()"> <a
					href="index1.jsp">返回首页</a></span>
			...
			<div class="reg_box clearfix">
				...
				<div class="reg_box_r fl">
					<h2 class="lg_sec_tit clearfix">
						<span class="fl">注册</span> <em class="fr">没有帐号，<a href="login.jsp">立即登录</a></em>
					</h2>
					<form method="post" action="register">
						<fieldset>
							<p class="mt20">
								<input type="text" placeholder="用户名" class="lg_input01 lg_input"
									name="username">
							</p>
							<p class="mt20">
							...
							<p class="mt20">
								<input type="text" placeholder="密码确认"
									class="lg_input02 lg_input" >
							</p>
							<p class="mt20">
								<input type="text" placeholder="邮箱号" class="lg_input03 lg_input"
									name=email>
							</p>
							...
							<p class="mt20">
								<input type="submit" class="lg_btn" value="立即注册">
							</p>
						</fieldset>
					</form>
				</div>
